...
//write json to file
if (file_put_contents("json/datalatih-knn-5-fold.json", $json_datalatih))
...
//write json to file
if (file_put_contents("json/datauji-knn-5-fold.json", $json_datauji))
...
// $estimator = new SVC(3, new Linear(), true, 0.5, 100.0);
