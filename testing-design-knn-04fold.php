...
// print_r("<pre>TF LATIH");
// print_r($array_latih);
// print_r("<pre>");
// print_r($datalatih_table1);
// print_r("<pre><h3>DATA LATIH</h3><br>");
// print_r($pertanyaandatalatihbaru);
// print_r("<pre><h3>DATA UJI<br></h3>");
// print_r($array_uji);
// print_r("<br>");
// print_r($label);
...
//write json to file
if (file_put_contents("json/datalatih-knn-4-fold.json", $json_datalatih))
...
//write json to file
if (file_put_contents("json/datauji-knn-4-fold.json", $json_datauji))
