...
//write json to file
if (file_put_contents("json/datalatih-knn-9-fold.json", $json_datalatih))
...
//write json to file
if (file_put_contents("json/datauji-knn-9-fold.json", $json_datauji))
...
$estimator = new KNearestNeighbors(6);
